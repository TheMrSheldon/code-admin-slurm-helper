...
<script lang="ts">
	...
	const PALETTE = [
		{ bg: 'rgba(251,191,36,0.10)',  line: 'rgba(251,191,36,0.55)'  },
		{ bg: 'rgba(52,211,153,0.10)',  line: 'rgba(52,211,153,0.55)'  },
		{ bg: 'rgba(56,189,248,0.10)',  line: 'rgba(56,189,248,0.55)'  },
		{ bg: 'rgba(167,139,250,0.10)', line: 'rgba(167,139,250,0.55)' },
		{ bg: 'rgba(251,113,133,0.10)', line: 'rgba(251,113,133,0.55)' },
		{ bg: 'rgba(251,146,60,0.10)',  line: 'rgba(251,146,60,0.55)'  },
		{ bg: 'rgba(45,212,191,0.10)',  line: 'rgba(45,212,191,0.55)'  },
		{ bg: 'rgba(232,121,249,0.10)', line: 'rgba(232,121,249,0.55)' },
	];
